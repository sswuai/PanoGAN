...
path_t, root_t, files_t = os.walk(img_real).next()
file_real_type = os.path.splitext(files_t[0])[-1]
...
for i in range(n):
    ...
    img_path_real = img_real + '/' + img_name + file_real_type
    img_path_synthesized = img_synthesized + '/' + img_name + file_real_type
