...
class PanoAligned3Dataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        B_transform = get_transform_pano(self.opt, transform_params, grayscale=(self.output_nc == 1))
        C_transform = get_transform_pano(self.opt, transform_params, grayscale=(self.output_nc == 1))
