...
"""
class panoganBaseline2A3MOdel(BaseModel):
    @staticmethod
    ...
    def backward_D(self):
        ...
        fake_SB = torch.cat((cond_input, self.fake_D12), 1)
        ...
        fake_SB = torch.cat((cond_input, self.fake_D123), 1)
        ...
        fake_SB = torch.cat((cond_input, self.fake_D1234), 1)
