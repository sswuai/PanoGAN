...
panoganBaseline2C1
    ...
    4. GAN loss for image and seg, input of Discriminator is the concate(previous input, fake_img/seg)
    5. L1 loss for img and seg
"""
class panoganBaseline2C1MOdel(BaseModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser.set_defaults(norm='batch', netG='unet_256', dataset_mode='panoaligned4')
        if is_train:
